...
NV = [5]
SV = [7]
# SE is not interesting, contains the odd squares

radius  = 1
total   = 5 # numbers total
primes  = 3 # primes count
num     = 7 # current number
ratio = primes / total
...
while ratio > 0.1
  ...
  putNum SV, num
  total++ # for SE
  # console.log NE, NV, SV
  # console.log "-----"
  # console.log primes, total
  ratio = primes / total
  console.log "#{size}: Ratio: #{ratio*100}"
